...
const info = [
  { icon: <FaPhoneAlt />, title: "Phone", description: "(+84) 365 421 105" },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "dev.nguyenphuong@gmail.com",
  },
  {
    icon: <FaMapMarkedAlt />,
    title: "Address",
  ...
  return (
    ...
    >
      <div className="container mx-auto">
        <div className="flex flex-col mx-auto xl:flex-row gap-[30px]">
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    ...
                    <SelectItem value="full">FullStack Development</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
              <Textarea
